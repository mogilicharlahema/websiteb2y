...
<section className="services-section">
  <div className="services-header">
    ...
    <h2 className="services-title">
      Delivering <span>cutting-edge digital solutions</span> that empower your business to innovate, scale, and succeed.
    </h2>
  </div>
    ...
    {[
      {
        id: "01",
        title: "AI SOLUTIONS",
        desc: "Empowering enterprises with AI-driven automation, predictive insights, and intelligent decision-making to revolutionize business operations.",
      },
      {
        id: "02",
        title: "WEB DEVELOPMENT",
        desc: "Crafting modern, scalable, and high-performance web applications that reflect your brand and accelerate digital transformation.",
      },
      {
        id: "03",
        title: "MOBILE APPLICATIONS",
        desc: "Building sleek, user-friendly mobile experiences for Android and iOS that boost engagement and drive customer satisfaction.",
      },
      {
        id: "04",
        title: "IT CONSULTING",
        desc: "Providing expert technology consulting, digital strategy, and infrastructure optimization to help you achieve your business goals.",
      },
    ].map((service, index) => (
      <div
        key={index}
        className={`service-card ${index === 2 ? "active-card" : ""}`}
        ref={(el) => (cardsRef.current[index + 10] = el)} // avoid overlap with previous refs
        style={{ transitionDelay: `${index * 0.2}s` }}
      >
